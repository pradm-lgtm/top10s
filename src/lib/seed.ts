...
const lists: ListSeed[] = [
  ...
  // ── 2021 TV ───────────────────────────────────
  {
    ...
    category: 'tv',
    entries: [
      { rank: 1, title: 'The Wire' },
      { rank: 2, title: 'Lupin (Season 1)' },
      { rank: 3, title: 'Dave (Season 2)' },
      { rank: 4, title: 'Loki (Season 1)' },
      { rank: 5, title: 'WandaVision' },
      { rank: 6, title: 'The Falcon and the Winter Soldier' },
    ],
