...
const lists: ListSeed[] = [
  ...
  // ── THEME: ALL-TIME TV ───────────────────────
  {
    ...
    entries: [
      ...
      { rank: 30, tier: 'The High Peaks Before Low Valleys',           title: 'The Last of Us (Season 1)' },
      { rank: 31, tier: 'The High Peaks Before Low Valleys',           title: 'Insecure' },
      // Tier 7
      { rank: 32, tier: 'The A− Comedies',                             title: 'The Good Place' },
      { rank: 33, tier: 'The A− Comedies',                             title: 'Curb Your Enthusiasm' },
      { rank: 34, tier: 'The A− Comedies',                             title: 'Arrested Development' },
      // Tier 8
      { rank: 35, tier: 'Golden Globe Interpretation Comedies',        title: 'Slow Horses' },
      { rank: 36, tier: 'Golden Globe Interpretation Comedies',        title: 'The Rehearsal' },
      { rank: 37, tier: 'Golden Globe Interpretation Comedies',        title: 'Barry' },
      { rank: 38, tier: 'Golden Globe Interpretation Comedies',        title: 'Sex Education' },
      { rank: 39, tier: 'Golden Globe Interpretation Comedies',        title: 'Louie' },
      { rank: 40, tier: 'Golden Globe Interpretation Comedies',        title: 'Ramy' },
      { rank: 41, tier: 'Golden Globe Interpretation Comedies',        title: 'Master of None' },
      // Tier 9
      { rank: 42, tier: 'My Sole But Rewarding Foray into Reality TV', title: 'The Traitors (US)' },
      // Tier 10
      { rank: 43, tier: 'The B+ Comedies',                             title: 'Hacks' },
      { rank: 44, tier: 'The B+ Comedies',                             title: 'Friends' },
      { rank: 45, tier: 'The B+ Comedies',                             title: 'Everybody Loves Raymond' },
      { rank: 46, tier: 'The B+ Comedies',                             title: 'New Girl' },
      { rank: 47, tier: 'The B+ Comedies',                             title: 'The League' },
      { rank: 48, tier: 'The B+ Comedies',                             title: 'American Vandal' },
      // Tier 11
      { rank: 49, tier: 'The Consistently Good, Maybe Never Great',    title: 'Narcos / Narcos: Mexico' },
      { rank: 50, tier: 'The Consistently Good, Maybe Never Great',    title: 'Friday Night Lights' },
      { rank: 51, tier: 'The Consistently Good, Maybe Never Great',    title: 'The White Lotus' },
      // Tier 12
      { rank: 52, tier: "Didn't Like It",                              title: 'Westworld' },
      // Tier 13
      { rank: 53, tier: 'Too Early to Rank',                           title: 'The Studio (Season 1)' },
    ],
  },
