...
const lists: ListSeed[] = [
  ...
  // ── THEME: ALL-TIME TV ───────────────────────
  {
    ...
    entries: [
      ...
      // Tier 7
      { rank: 31, tier: 'The A− Comedies',                         title: 'The Good Place' },
      { rank: 32, tier: 'The A− Comedies',                         title: 'Curb Your Enthusiasm' },
      { rank: 33, tier: 'The A− Comedies',                         title: 'Arrested Development' },
      // Tier 8
      { rank: 34, tier: 'Golden Globe Interpretation Comedies',    title: 'Slow Horses' },
      { rank: 35, tier: 'Golden Globe Interpretation Comedies',    title: 'The Rehearsal' },
      { rank: 36, tier: 'Golden Globe Interpretation Comedies',    title: 'Sex Education' },
      { rank: 37, tier: 'Golden Globe Interpretation Comedies',    title: 'Louie' },
      { rank: 38, tier: 'Golden Globe Interpretation Comedies',    title: 'Ramy' },
      { rank: 39, tier: 'Golden Globe Interpretation Comedies',    title: 'Master of None' },
      // Tier 9
      { rank: 40, tier: 'My Sole But Rewarding Foray into Reality TV', title: 'The Traitors (US)' },
      // Tier 10
      { rank: 41, tier: 'The B+ Comedies',                         title: 'Hacks' },
      { rank: 42, tier: 'The B+ Comedies',                         title: 'Friends' },
      { rank: 43, tier: 'The B+ Comedies',                         title: 'Everybody Loves Raymond' },
      { rank: 44, tier: 'The B+ Comedies',                         title: 'New Girl' },
      { rank: 45, tier: 'The B+ Comedies',                         title: 'The League' },
      // Tier 11
      { rank: 46, tier: 'The Consistently Good, Maybe Never Great', title: 'Narcos / Narcos: Mexico' },
      { rank: 47, tier: 'The Consistently Good, Maybe Never Great', title: 'Friday Night Lights' },
      { rank: 48, tier: 'The Consistently Good, Maybe Never Great', title: 'The White Lotus' },
      // Tier 12
      { rank: 49, tier: 'Too Early to Rank',                       title: 'The Studio (Season 1)' },
    ],
  },
