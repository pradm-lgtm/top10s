...
const lists: ListSeed[] = [
  ...
  // ── THEME: ALL-TIME TV ───────────────────────
  {
    ...
    entries: [
      ...
      { rank: 20, tier: 'Short But Great Runs',                        title: 'I May Destroy You' },
      { rank: 21, tier: 'Short But Great Runs',                        title: 'The Pitt' },
      { rank: 22, tier: 'Short But Great Runs',                        title: 'Jury Duty' },
      { rank: 23, tier: 'Short But Great Runs',                        title: 'Flight of the Conchords' },
      // Tier 6
      { rank: 24, tier: 'The High Peaks Before Low Valleys',           title: 'True Detective (Season 1)' },
      { rank: 25, tier: 'The High Peaks Before Low Valleys',           title: 'The Bear (Seasons 1 & 2)' },
      { rank: 26, tier: 'The High Peaks Before Low Valleys',           title: 'Ted Lasso (Season 1)' },
      { rank: 27, tier: 'The High Peaks Before Low Valleys',           title: 'House of Cards (Season 1)' },
      { rank: 28, tier: 'The High Peaks Before Low Valleys',           title: 'Severance (Season 1)' },
      { rank: 29, tier: 'The High Peaks Before Low Valleys',           title: 'Big Little Lies (Season 1)' },
      { rank: 30, tier: 'The High Peaks Before Low Valleys',           title: 'Stranger Things' },
      { rank: 31, tier: 'The High Peaks Before Low Valleys',           title: 'The Last of Us (Season 1)' },
      { rank: 32, tier: 'The High Peaks Before Low Valleys',           title: 'Insecure' },
      // Tier 7
      { rank: 33, tier: 'The A− Comedies',                             title: 'The Good Place' },
      { rank: 34, tier: 'The A− Comedies',                             title: 'Curb Your Enthusiasm' },
      { rank: 35, tier: 'The A− Comedies',                             title: 'Arrested Development' },
      // Tier 8
      { rank: 36, tier: 'Golden Globe Interpretation Comedies',        title: 'Slow Horses' },
      { rank: 37, tier: 'Golden Globe Interpretation Comedies',        title: 'The Rehearsal' },
      { rank: 38, tier: 'Golden Globe Interpretation Comedies',        title: 'Barry' },
      { rank: 39, tier: 'Golden Globe Interpretation Comedies',        title: 'Sex Education' },
      { rank: 40, tier: 'Golden Globe Interpretation Comedies',        title: 'Louie' },
      { rank: 41, tier: 'Golden Globe Interpretation Comedies',        title: 'Ramy' },
      { rank: 42, tier: 'Golden Globe Interpretation Comedies',        title: 'Master of None' },
      // Tier 9
      { rank: 43, tier: 'My Sole But Rewarding Foray into Reality TV', title: 'The Traitors (US)' },
      // Tier 10
      { rank: 44, tier: 'The B+ Comedies',                             title: 'Hacks' },
      { rank: 45, tier: 'The B+ Comedies',                             title: 'Friends' },
      { rank: 46, tier: 'The B+ Comedies',                             title: 'Everybody Loves Raymond' },
      { rank: 47, tier: 'The B+ Comedies',                             title: 'New Girl' },
      { rank: 48, tier: 'The B+ Comedies',                             title: 'The League' },
      { rank: 49, tier: 'The B+ Comedies',                             title: 'American Vandal' },
      // Tier 11
      { rank: 50, tier: 'The Consistently Good, Maybe Never Great',    title: 'Narcos / Narcos: Mexico' },
      { rank: 51, tier: 'The Consistently Good, Maybe Never Great',    title: 'Friday Night Lights' },
      { rank: 52, tier: 'The Consistently Good, Maybe Never Great',    title: 'The White Lotus' },
      // Tier 12
      { rank: 53, tier: "Didn't Like It",                              title: 'Westworld' },
      // Tier 13
      { rank: 54, tier: 'Too Early to Rank',                           title: 'The Studio (Season 1)' },
    ],
  },
